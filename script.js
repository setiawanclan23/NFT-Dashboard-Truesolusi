...
{
  name: 'LISAðŸ–¤',
  handler: '@lalalalisa_m',
  image: 'https://img.i-scmp.com/cdn-cgi/image/fit=contain,width=425,format=auto/sites/default/files/styles/768x768/public/d8/images/methode/2020/04/09/0dec21b2-7a1c-11ea-9b24-e7152d1bf921_image_hires_181817.jpg?itok=xAg_QXKq&v=1586427505' },

{
  name: 'Nancy â¤ï¸',
  handler: '@nancyjewel_mcdonie_',
  image: 'https://tnhrce.org/wp-content/uploads/2022/09/nancy_jewel_mcdonie_1_17_09_2022.jpg' },
...
function Header() {
  return /*#__PURE__*/(
    ...
    React.createElement("img", {
      src: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiCp--pfz_9tWA9_lDG5xqxNUpkGFUxE3cheUwY__0kM9-yl8tNFsWXBxYGfxgfclWFtd3TU4ydQ4nRHLhG08OFBoVOjRzq5ehWssX4UQmLFZUBwzYmpEV-QEp23dPtOrRNiRQ6FM5OTzS4sBZHTEzswjByJlbEvGK4v_Nabs2vtVG37g/w72-h72-p-k-no-nu/Radar%20Politan.png",
      alt: "user",
